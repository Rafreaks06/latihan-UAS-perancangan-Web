// UAS Perancangan Web - Sistem Pembayaran Sederhana
       ...
       document.addEventListener('DOMContentLoaded', function() {
        ...
        const promoCodes = {
            CINTAGLOBAL: {type:'percentage',discount:50,description:'Diskon Uang Gedung'},
            CINTAGLOBALBANGET: {
                type: 'percentage', 
                discount: 99, 
                description: 'penghuni Global'},
            KULIAHENAKTAU: {
                type:'fixed',
                discount: 10000, 
                description:'Yang Rajin Kalo di Global'}
        ...
        function processPayment(formData) {
            ...
            const transaction = {
                ...
                customerNim : formData.get('customerNim'),
            ...
            paymentDetails.innerHTML = `
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium">${transaction.customerNim}</span>
                    </div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium">${transaction.quantity} Bulan</span>
